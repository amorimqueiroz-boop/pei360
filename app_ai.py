...
with tab6:
    ...
    with col_btn:
        ...
        # Expander robusto com o racional da IA
        with st.expander("🔍 Entenda a Lógica da Análise"):
            st.markdown("""
            **1. Cruzamento Legal:** Verificação automática com o Decreto 12.686/2025.
            **2. Análise Neurofuncional:** Identificação de falhas nas Funções Executivas (Memória, Controle Inibitório).
            **3. Alinhamento BNCC:** Seleção de habilidades essenciais do ano letivo indicado.
            **4. Verificação de Suporte:** Se o suporte for 'Muito Substancial', sugiro mediação humana.
            """)
